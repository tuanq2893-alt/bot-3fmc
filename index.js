...
// Proxy SOCKS5 Việt Nam đang Online
const PROXY_HOST = '118.70.67.11'; 
const PROXY_PORT = 1080;

function createBot() {
  console.log(`>>> [1/5] Kết nối qua Proxy VN (${PROXY_HOST}:${PROXY_PORT})...`);
  ...
  SocksClient.createConnection({
    ...
    if (err) {
      console.log('Lỗi Proxy VN, đang thử kết nối lại sau 5s:', err.message);
