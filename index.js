...
// IP GỐC CỦA 3FMC (Bypass Cloudflare Web CDN)
const SERVER_IP = '171.244.24.2';
const SERVER_PORT = 25565;

function createBot() {
  console.log(`>>> [1/5] Đang kết nối trực tiếp IP gốc (${SERVER_IP}:${SERVER_PORT})...`);
  ...
  bot.on('end', (reason) => {
    console.log(`Mất kết nối (${reason})! Đang thử kết nối lại sau 5s...`);
